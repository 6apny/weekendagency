*Реализована возможность добавления, изменения и удаления зайца. Использован стек React + Redux(Redux-thunk) Скачать репозиторий, в терминале прописать npm install & npm start.*
